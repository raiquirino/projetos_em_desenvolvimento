    ...
    try:
        ...
        if 0 <= escolha < len(arquivos_pdf):
            ...
            def extrair_valores(texto):
                # Padrão para capturar valores com separadores de milhares
            ...
            df = pd.DataFrame({'Data': datas, 'Histórico': linhas_processadas, 'Valor': valores})

            # Preencher células vazias na coluna 'Data' com o último valor válido
            df['Data'] = df['Data'].ffill()

            # Converter a coluna 'Histórico' para string, garantindo compatibilidade
            ...
            substituicoes = {
                "CESTA PJ ": "TARIFA BANCARIA",
                "Padrao2": "Substituicao2",
                "Padrao3": "Substituicao3",
            }
            ...
            print(f"Arquivo salvo: '{nome_arquivo_excel}'")
        else:
